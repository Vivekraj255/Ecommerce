        ...
        <div class="topn">
            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    	<h4 class="header-line"><span><center>View Products</center></span></h4>
                    <div class="row">
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        ...
                                        <%
                                            ResultSet rs = DatabaseConnection.getResultFromSqlQuery("select * from tblproducts where shopkeeper_code='"+session.getAttribute("code")+"' and shopkeeper_name='"+session.getAttribute("email")+"'");
                                            while (rs.next()) {
                                        %>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a
                                                        href="shopkeeper-edit-product.jsp?id=<%=rs.getInt("id")%>"
                                                        class="btn btn-primary">Edit</a>|<a
                                                        href="shopkeeper-delete-product.jsp?id=<%=rs.getInt("id")%>"
