...
%>
     ...
     <form method="post" action="shopkeeperLoginAction.jsp" class="form" id="lform"> 

      <div class="inputBox"> 

       <input type="text" name="s_name"  required > <i>Username</i> 

      </div> 

      <div class="inputBox"> 

       <input type="password" name="s_pass"  required > <i>Password</i> 

      </div> 

      <div class="links"> <a href="forgotPassword.jsp">Forgot Password?</a> <a href="shopkeeper-singup.jsp">Signup</a> </div> 
