                    ...
                    <div class="col-md-12">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <form role="form" action="addProductsAction.jsp" method="post"
                                      enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label>Shopkeeper Name</label> <input class="form-control" type="text" name="S_name" value="<%=session.getAttribute("uname")%>" required />
                                    </div>
