...
%>
     ...
     <form method="post" action="LoginAction.jsp" class="form" id="lform"> 

      <div class="inputBox"> 

       <input type="text" name="usrname"  required > <i>Username</i> 

      </div> 

      <div class="inputBox"> 

       <input type="password" name="usrpass"  required > <i>Password</i> 

      </div> 

      <div class="links"> <a href="forgotPassword.jsp">Forgot Password?</a> <a href="signup.jsp">Signup</a> </div> 
