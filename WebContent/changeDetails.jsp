...
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
 ...
 <hr>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
 <h3>&nbsp; Gender: <%=rs.getString(4) %>. </h3>
 <hr>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<h3>&nbsp; Address: <%=rs.getString(8) %>. </h3>
<hr>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<h3>&nbsp; State: <%=rs.getString(10) %>. </h3>
<hr>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<h3>&nbsp; City: <%=rs.getString(11) %>. </h3>
<hr>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<h3>&nbsp; Pin_code: <%=rs.getString(9) %>. </h3>
<hr>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<h3>&nbsp; Country: <%=rs.getString(12) %>. </h3>
<hr>
      <br>
      <br>
      <br>
