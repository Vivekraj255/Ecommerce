    ...
    <div class="content"> 
     ...
     <form action="forgotPassword" method="post" class="form"> 
      ...
      <div class="inputBox"> 
       ...
       <input type="text" name="email" id="email-for-pass" required=""> <i>Username/Mobile No.</i> 
      ...
      <div class="links"> <a href="enterOtp.jsp">verification</a> <a href="index.jsp">Login</a> </div>
